...
function onCreate()
    makeLuaSprite('healtBarMario', 'nobar', 285, 621)
    setObjectCamera('healtBarMario', 'HUD') 
    addLuaSprite('healtBarMario', true)
    setObjectOrder('healtBarMario', getObjectOrder('healthBar') + 1)
